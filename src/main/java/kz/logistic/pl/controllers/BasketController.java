...
public class BasketController {
  ...
  @ApiOperation("Удаляет корзину по login_id")
  @DeleteMapping("deleteByLoginId")
  public ResponseEntity<?> deleteByLoginId(@RequestParam Long id) {
    return ResponseEntity.ok(basketService.deleteByLoginId(id));
  }
}
